...
export async function completeLessonById({
  ...
  console.log("completeLessonById lessonId:", lessonId, "clerkId:", clerkId);
  try {
    // Get Sanity student ID from Clerk ID
    const student = await getStudentByClerkId(clerkId);
    console.log("completeLessonById student:", student);
    ...
    console.log("completeLessonById existingCompletion:", existingCompletion);
    ...
    console.log("completeLessonById creating completion");
    ...
    console.log("completeLessonById completion:", completion);
