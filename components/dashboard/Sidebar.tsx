...
export function Sidebar({ course, completedLessons = [] }: SidebarProps) {
  ...
  return (
    <>
      {/* Thin Mobile Sidebar */}
      <aside className="fixed inset-y-0 left-0 z-50 flex flex-col items-center w-[60px] border-r border-border bg-background lg:hidden py-4 gap-y-4">
      ...
      <aside
        className={cn(
          ...
          "lg:z-50 lg:block lg:w-96 lg:border-r lg:border-border",
          isOpen
