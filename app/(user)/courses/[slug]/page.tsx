          ...
          <div className="lg:col-span-2">
            <div className="bg-card rounded-lg p-6 mb-8 border border-border">
              ...
              <div className="space-y-4">
                {course.modules?.map((module: { _id: string; title: string; lessons?: Array<{ _id: string; title: string }> }, index: number) => (
                  <div
                    key={module._id}
                  ...
                  >
                    ...
                    <div className="divide-y divide-border">
                      {module.lessons?.map((lesson: { _id: string; title: string }, lessonIndex: number) => (
                        <div
                          key={lesson._id}
